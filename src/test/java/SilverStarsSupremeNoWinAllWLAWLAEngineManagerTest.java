...
public class SilverStarsSupremeNoWinAllWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SilverStarsSupremeNoWinAllWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SilverStarsSupremeNoWinAllWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SilverStarsSupremeNoWinAllWLAIW/InitOutcome.xml").getDocumentElement();
